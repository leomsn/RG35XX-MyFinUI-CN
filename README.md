...
2. **系统**: `MinUI.zip` (已预置中文字体) 和 `dmenu.bin`。
   > [!TIP]
   > 请前往本仓库的 [Releases](https://github.com/leomsn/RG35XX-MyFinUI-CN/releases) 页面下载 **.IMG 镜像** 和 **MinUI.zip**。这样可以避免占用仓库 LFS 额度，下载也更快速。
